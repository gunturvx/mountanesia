		...
		<div class="login-content">
    		...
    		<!-- re password -->
                    <div class="input-div pass">
           		   ...
           		   <div class="div">
                        <input type="password" name="passwordConf" class="text-input"  placeholder="konfirmasi password" >
                    </div>
                  </div>
                    <div>
                        <a href="login.php">Sudah punya akun</a>
                        <button type="submit" name="register-btn" class="btn solid">Register</button>
                    </div>
                </form>
